	...
	<div id="innerSetDiv" style="display: inline-block;">
		<form method="POST" action="einstellungen2.php">
			<div class="settingsHeader inboxh">
				<b>Verhalten der nichtzugewiesenen Arbeiter:</b><br>(Alle zur
				verf&uuml;gung stehende Arbeitskr&auml;fte die in keinem
				Geb&auml;ude arbeiten)
			</div>
			<div class="settingsLine inboxh">
				<select name="arbeitstatus"
					onchange="updateDescription(this, this.nextElementSibling);">
					<option value="-1"
						{{arbeitstatus-1}} title="Keine Besch&auml;ftigung / kein Lohn, Moralminus">Arbeitslos</option>
					<option value="0"
						{{arbeitstatus0}} title="Arbeitskr&auml;fte durchsuchen Provinz nach n&uuml;tzlichen Rohstoffen / 100% Lohn">Sammeln</option>
					<option value="1"
						{{arbeitstatus1}} title="Arbeitskr&auml;fte gehen auf die Tierjagd und versuchen Nutztiere einzufangen / 100% Lohn">Jagen</option>
					<option value="2"
						{{arbeitstatus2}} title="Keine Besch&auml;ftigung / 70% Lohn, kein Moralminus">Arbeitslosengeld</option>
				</select> - <span></span>
			</div>

			<div class="settingsHeader inboxh">
				<b>Verhalten der Rentner:</b><br>(Alle welche das Rentenalter
				erreicht haben)
			</div>
			<div class="settingsLine inboxh">
				<select name="rentestatus"
					onchange="updateDescription(this, this.nextElementSibling);">
					<option value="-1"
						{{rentestatus-1}} title="Keine Besch&auml;ftigung / kein Lohnersatz, Moralminus">keine
						Rente</option>
					<option value="0"
						{{rentestatus0}} title="Keine Besch&auml;ftigung / 70% Lohnersatz, kein Moralminus">Rentengeld</option>
				</select> - <span></span>
			</div>
			...
			<div class="settingsLine inboxh">
				Wenn Sie die Steuers&auml;tze &auml;ndern hat das sofortigen
				Einfluss auf die Provinzmoral. <br>Aber auch zuk&uuml;nftig
				beeinflussen die Steuers&auml;tze die Provinzmoral weiter. <br>
				<span class="hinweis">Achtung: Negative &Auml;nderungen
					wirken sich dauerhaft h&ouml;her auf die <br>Moral aus als
					positive &Auml;nderungen.
				</span>
			</div>
			<div class="settingsLine inboxh">
				<div style="display: inline-block;">
					Einkommenssteuer: <select name="steuersatz">
						...
						<option value="1" {{steuersatz1}} title="sehr niedrig">sehr
							niedrig</option>
						...
						<option value="5" {{steuersatz5}} title="sehr hoch">sehr
							hoch</option>
				...
				<div style="display: inline-block;">
					Verm&ouml;genssteuer: <select name="steuersatzv">
						...
						<option value="1" {{steuersatzv1}} title="sehr niedrig">sehr
							niedrig</option>
						...
						<option value="5" {{steuersatzv5}} title="sehr hoch">sehr
							hoch</option>
			...
			<div class="settingsHeader inboxh">
				<b>Geburtenverhalten festlegen:</b>
			</div>
			<div class="settingsLine inboxh">
				<select name="geburtenstatus"
					onchange="updateDescription(this, this.nextElementSibling);">
					<option value="-2"
						{{geburtenstatus-2}} title="max. 1 Kind pro Familie">starke
						Geburtenkontrolle</option>
					<option value="-1"
						{{geburtenstatus-1}} title="max. 2 Kinder pro Familie">geringe
						Geburtenkontrolle</option>
					<option value="0" {{geburtenstatus0}} title="">Keine
						Einmischung</option>
					<option value="1" {{geburtenstatus1}} title="1000 Mips/Kind">Kinderzulagen</option>
					<option value="2" {{geburtenstatus2}} title="2500 Mips/Kind">hohe
						Kinderzulagen</option>
				</select> - <span></span>
			</div>

			<div class="settingsHeader inboxh">
				<b>Verhalten von Techgeb&auml;uden:</b>
			</div>
			<div class="settingsLine inboxh">
			...
			<div class="settingsLine inboxh">
				<input name="feiertag" value="1" class="formcenter" type="checkbox"{{feiertag}}>
				Heutigen Tag zum Feiertag erkl&auml;ren.<br>(Keiner muss
				arbeiten, wird aber trotzdem bezahlt. (Moralschub))
			</div>
			<div class="settingsLine inboxh">
				Prozentualer Einkommensanteil an Staatskasse: <input type="text"
					name="staatsabgabenstatus" id="staatsabgabenstatus"
					value="{{staatsabgabenstatus}}" size="3" onchange="updateSlider()">%&nbsp&nbsp
			...
			<div>
				<input class="formcenter" type="submit" value="aktualisieren">
			</div>
		</form>
	</div>
</div>